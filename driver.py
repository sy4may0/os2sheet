...
ip = '10.51.1.95'
user = 'fjse'
keyfile = '/home/acmos/iwata/.ssh/id_ed25519'

cmd_runner = CommandRunner(ip, user, password='sy4MaY0$cm05', keyfile=keyfile)
cmd_runner.su('dpss@RoFJ202401')

#selinux_config = linux_general.selinux(cmd_runner)
#print(selinux_config)
#
#sysconfig_grub_config = linux_general.sysconfig_grub(cmd_runner)
#pprint(sysconfig_grub_config)
#
...
#systemd_config = linux_general.systemd_unit(cmd_runner)
#pprint(systemd_config)
#
#rpm_pkgs = linux_general.rpm_pkgs(cmd_runner)
#pprint(rpm_pkgs)
#
